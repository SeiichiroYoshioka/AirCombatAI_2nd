...
DECLARE_CLASS_WITHOUT_TRAMPOLINE(R4RewardSample01,TeamReward)
    /*いくつかの観点に基づいた報酬の実装例。
    ...
    */
    ...
    R4RewardSample01(const nl::json& modelConfig_,const nl::json& instanceConfig_);
    virtual ~R4RewardSample01();
    //functions
