...
DECLARE_CLASS_WITHOUT_TRAMPOLINE(R4RewardSample02,AgentReward)
	...
	*/
    ...
    R4RewardSample02(const nl::json& modelConfig_,const nl::json& instanceConfig_);
    virtual ~R4RewardSample02();
    //functions
